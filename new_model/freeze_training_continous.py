...
epoch_values = list(range(1200, 1210, 20))
...
for epochs in epoch_values:
    ...
    # 2. SHARED WORKSPACE PATH (Where MACE actually trains continuously)
    # The folder name and model name MUST stay frozen across all iterations
    ...
    ###############################################################
    # Perform training (UNTOUCHED MACE CORE)
    ###############################################################
    import warnings
    ...
    ###############################################################
    # THE EXTRACTION STEP 
    # Copies the model out and renames it to match your milestone naming format
    ###############################################################
